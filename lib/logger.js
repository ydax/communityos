...
// Attempt to initialize Cloud Logging client once at module load.
// If credentials are unavailable (e.g., local dev without ADC), the SDK
// will throw at write-time, and we fall back gracefully to console output.
let cloudLog = null;
